...
ExpNormtoHeatmap = function(tbl.clean, threshold){
  ...
  k = heatmap.2(as.matrix(log(ExpNorm.tbl.clean.logFC, base = 2)), trace = "none", col = Colors,Rowv = FALSE, Colv = FALSE, main = "Male 15Mo vs 6Mo heatmap (log2FC > 0.3)")
